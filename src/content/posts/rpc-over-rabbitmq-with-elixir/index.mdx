...
date: '2020-11-23'
coverImage: /posts/rpc-over-rabbitmq-with-elixir/cover-image.jpg
tags:
  - elixir
  - community
---
...
![Cover image people queuing](/posts/rpc-over-rabbitmq-with-elixir/cover-image.jpg)

<UnsplashCredit name="amandazi photography" link="https://unsplash.com/@amandazi_photography?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText" />
...
![Sketch of caller and receiver of an RPC](/posts/rpc-over-rabbitmq-with-elixir/sketch-rpc-definition.png)
...
![Sketch of RabbitMQ topology](/posts/rpc-over-rabbitmq-with-elixir/sketch-rabbitmq-topology.png)
...
![Sketch of the architecture of the sender service](/posts/rpc-over-rabbitmq-with-elixir/sketch-caller-architecture.png)
...
![Sketch of the supervision tree](/posts/rpc-over-rabbitmq-with-elixir/sketch-supervision-tree.png)
...
![Sketch of the pool supervision tree](/posts/rpc-over-rabbitmq-with-elixir/sketch-receiver-architecture.png)
