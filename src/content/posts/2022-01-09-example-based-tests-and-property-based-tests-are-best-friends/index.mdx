...
date: '2022-01-09'
coverImage: /posts/example-based-tests-and-property-based-tests-are-best-friends/cover-image.jpg
tags:
  - elixir
  - community
---
...
![Cover image of just a bunch of pencils](/posts/example-based-tests-and-property-based-tests-are-best-friends/cover-image.jpg)

<UnsplashCredit name="David Pennington" link="https://unsplash.com/@dtpennington?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText" />
