...
date: '2019-04-14'
coverImage: /posts/connection-managers-with-gen_statem/cover-image.jpg
tags:
  - elixir
aliases:
  - /posts/connection-managers-with-gen_s
  - /posts/connection-managers-with-gen-statem
---
...
![Cover image of a electricity](/posts/connection-managers-with-gen_statem/cover-image.jpg)

<UnsplashCredit name="Israel Palacio" link="https://unsplash.com/photos/ImcUkZ72oUs?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText" />
...
![ATM state machine diagram](/posts/connection-managers-with-gen_statem/atm-state-machine-diagram.png)
...
![Connection state machine diagram](/posts/connection-managers-with-gen_statem/connection-state-machine-diagram.png)
