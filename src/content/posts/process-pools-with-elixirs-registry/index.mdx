...
date: '2020-04-25'
coverImage: /posts/process-pools-with-elixirs-registry/cover-image.jpg
tags:
  - elixir
---
...
![Cover image of a pool](/posts/process-pools-with-elixirs-registry/cover-image.jpg)

<UnsplashCredit name="Etienne Girardet" link="https://unsplash.com/@etiennegirardet?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText" />
...
![Sketch of a checkout pool](/posts/process-pools-with-elixirs-registry/sketch-checkout-pool.png)
...
![Sketch of a routing pool](/posts/process-pools-with-elixirs-registry/sketch-routing-pool.png)
...
![Sketch of the pool supervision tree](/posts/process-pools-with-elixirs-registry/pool-supervision-tree.png)
