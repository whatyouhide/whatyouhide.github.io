...
title: Tirana
description: >
  Visits to Tirana, Albania: the breakneck pace of change between my two
  visits in 2023 and 2026, and the food worth seeking out.
country: ALB
countryName: Albania
flag: 🇦🇱
...
import imgViewFromHotel from "./view-from-hotel.jpg";
import imgViewFromSkyClub from "./view-from-sky-club.jpg";
...
<Figure src={imgViewFromHotel} alt="View from hotel elevator" width="65%">
...
<Figure src={imgViewFromSkyClub} alt="View from Sky Club" width="65%">
